        ...
        <div class="container-fluid">
            ...
            <form action="gerenciar_menu.do" method="POST">
                ...
                <div>
                    ...
                    <input type="text" id="link_men" name="link_men" required="" value="${menu.link_men}" maxlength="45"/><br>
                    <label for="exibir_men">Exibir</label>
                    <select name="exibir_men">
                        <option value="1" 
                                <c:if test="${menu.exibir_men==1}"> selected="" </c:if>
                        >Sim </option>
                        <option value="2" 
                                <c:if test="${menu.exibir_men==2}"> selected="" </c:if>
                        >Não</option>
                    </select>
                </div>
                <div>
                    <button>Gravar</button>
                    <a href="listar_menu.jsp">Voltar</a>
                </div>
